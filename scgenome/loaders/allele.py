...
def load_haplotype_allele_counts_from_results(results_dir):
    ...
    return load_haplotype_allele_counts(allele_counts_filepath)


def load_haplotype_allele_counts(allele_counts_filepath):
